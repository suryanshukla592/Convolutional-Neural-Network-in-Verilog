`timescale 1ns / 1ps
/* no need for signed reg, since the numbers will 
always be +ve cause of the ReLu Activation function*/
...
always @(posedge clk) begin
    if(!reset) begin
        ...
        if(col_count == b_size-1) begin
            col_count <= 0;
            // NEW: Explicitly reset the row counter at the end of the image!
            if (row_count == b_size-1) begin
                row_count <= 0; end
            else begin
